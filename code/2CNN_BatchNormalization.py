...
#predictand.plot()
# predictand[predictand<-0.5] = np.nan
# predictand[predictand>0.5] = np.nan
# predictand_max = predictand.resample('D').max()
predictand_rolling = predictand.copy()
# predictand_rolling = predictand.rolling(12,center=True).mean()
# predictand_rolling_max = predictand_rolling.resample('D').max()
...
fn_model = r'E:\github\Coastal-hydrographs\MachineLearning\RNN\MODELS'
name_model = '2D_CNN_CuxHaven_MaxDay_BATCH'
...
rho_cnn1= layers.BatchNormalization()(rho_cnn1)
...
phi_cnn1= layers.BatchNormalization()(phi_cnn1)
...
comb_msl_grad_cnn= layers.BatchNormalization()(comb_msl_grad_cnn)
...
msl_cnn1= layers.BatchNormalization()(msl_cnn1)
...
grad_cnn1= layers.BatchNormalization()(grad_cnn1)
...
#model = keras.models.load_model(os.path.join(fn_model, '2D_CNN_Try_rolling'))
...
#yhat = model.predict([rho_scaled, phi_scaled, msl_scaled, grad_scaled], verbose=0)
